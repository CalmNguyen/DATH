            ...
            <div>
                ...
                <form style={{ margin: 20 }}>
                    <div className="form-group" style={{ width: '85%' }}>
                        ...
                        <input onChange={(event) => set_nameProject(event.target.value)} type="text" className="form-control" id="exampleFormControlInput1" placeholder="Gán nhãn phân loại thông tin"></input>
                    </div>
                    <div className="form-group" style={{ width: '85%' }}>
                    ...
                    <div class="form-group" style={{ width: '85%' }}>
                        ...
                        <input onChange={(event) => set_maxEmployees(event.target.value)} type="text" class="form-control" id="exampleFormControlInput1" placeholder="30"></input>
                    </div>
